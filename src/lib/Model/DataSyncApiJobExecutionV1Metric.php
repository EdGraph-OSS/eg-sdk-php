...
/**
 * DataSyncApiJobExecutionV1Metric Class Doc Comment
 *
 * @category Class
 * @package  EdGraph\PlatformClient
 * @author   OpenAPI Generator team
 ...
 */
class DataSyncApiJobExecutionV1Metric implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DataSyncApi.JobExecution.V1.Metric';
