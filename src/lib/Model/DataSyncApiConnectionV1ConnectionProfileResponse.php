...
/**
 * DataSyncApiConnectionV1ConnectionProfileResponse Class Doc Comment
 *
 * @category Class
 * @package  EdGraph\PlatformClient
 * @author   OpenAPI Generator team
 ...
 */
class DataSyncApiConnectionV1ConnectionProfileResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DataSyncApi.Connection.V1.ConnectionProfileResponse';
    ...
    protected static $openAPITypes = [
        ...
        'connectionId' => 'string',
        'name' => 'string',
        'connectionMetadata' => '\EdGraph\PlatformClient\Model\DataSyncApiConnectionV1ConnectionMetadata[]',
        'providerId' => 'string',
        'providerName' => 'string',
    ...
    protected static $setters = [
        ...
        'name' => 'setName',
        'connectionMetadata' => 'setConnectionMetadata',
        'providerId' => 'setProviderId',
        'providerName' => 'setProviderName',
        'connectionTypeId' => 'setConnectionTypeId',
        'connectionTypeName' => 'setConnectionTypeName',
    ...
    protected static $getters = [
        ...
        'connectionTypeId' => 'getConnectionTypeId',
        'connectionTypeName' => 'getConnectionTypeName',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('connectionMetadata', $data ?? [], null);
        $this->setIfExists('providerId', $data ?? [], null);
        $this->setIfExists('providerName', $data ?? [], null);
        $this->setIfExists('connectionTypeId', $data ?? [], null);
        $this->setIfExists('connectionTypeName', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets connectionMetadata
     *
     * @return \EdGraph\PlatformClient\Model\DataSyncApiConnectionV1ConnectionMetadata[]|null
     */
    public function getConnectionMetadata()
    {
        return $this->container['connectionMetadata'];
    }

    /**
     * Sets connectionMetadata
     *
     * @param \EdGraph\PlatformClient\Model\DataSyncApiConnectionV1ConnectionMetadata[]|null $connectionMetadata connectionMetadata
     *
     * @return self
     */
    public function setConnectionMetadata($connectionMetadata)
    {
        if (is_null($connectionMetadata)) {
            array_push($this->openAPINullablesSetToNull, 'connectionMetadata');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('connectionMetadata', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['connectionMetadata'] = $connectionMetadata;
    ...
    /**
     * Gets connectionTypeId
     *
     * @return string|null
     */
    public function getConnectionTypeId()
    {
        return $this->container['connectionTypeId'];
    }

    /**
     * Sets connectionTypeId
     *
     * @param string|null $connectionTypeId connectionTypeId
     *
     * @return self
     */
    public function setConnectionTypeId($connectionTypeId)
    {
        if (is_null($connectionTypeId)) {
            array_push($this->openAPINullablesSetToNull, 'connectionTypeId');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('connectionTypeId', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['connectionTypeId'] = $connectionTypeId;

        return $this;
    }

    /**
     * Gets connectionTypeName
     *
     * @return string|null
     */
    public function getConnectionTypeName()
    {
        return $this->container['connectionTypeName'];
    }

    /**
     * Sets connectionTypeName
     *
     * @param string|null $connectionTypeName connectionTypeName
     *
     * @return self
     */
    public function setConnectionTypeName($connectionTypeName)
    {
        if (is_null($connectionTypeName)) {
            array_push($this->openAPINullablesSetToNull, 'connectionTypeName');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('connectionTypeName', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['connectionTypeName'] = $connectionTypeName;
