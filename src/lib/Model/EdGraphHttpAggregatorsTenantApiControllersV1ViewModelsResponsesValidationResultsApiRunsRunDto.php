...
/**
 * EdGraphHttpAggregatorsTenantApiControllersV1ViewModelsResponsesValidationResultsApiRunsRunDto Class Doc Comment
 *
 * @category Class
 * @package  EdGraph\PlatformClient
 * @author   OpenAPI Generator team
 ...
 */
class EdGraphHttpAggregatorsTenantApiControllersV1ViewModelsResponsesValidationResultsApiRunsRunDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EdGraph.HttpAggregators.Tenant.Api.Controllers.v1.ViewModels.Responses.ValidationResultsApi.Runs.RunDto';
    ...
    protected static $setters = [
        ...
        'status' => 'setStatus',
        'host' => 'setHost',
        'validationEngine' => 'setValidationEngine',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('validationEngine', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets validationEngine
     *
     * @return string|null
     */
    public function getValidationEngine()
    {
        return $this->container['validationEngine'];
    }

    /**
     * Sets validationEngine
     *
     * @param string|null $validationEngine validationEngine
     *
     * @return self
     */
    public function setValidationEngine($validationEngine)
    {
        if (is_null($validationEngine)) {
            array_push($this->openAPINullablesSetToNull, 'validationEngine');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('validationEngine', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['validationEngine'] = $validationEngine;
