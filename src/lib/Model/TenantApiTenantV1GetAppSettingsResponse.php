...
/**
 * TenantApiTenantV1GetAppSettingsResponse Class Doc Comment
 *
 * @category Class
 * @package  EdGraph\PlatformClient
 * @author   OpenAPI Generator team
 ...
 */
class TenantApiTenantV1GetAppSettingsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TenantApi.Tenant.V1.GetAppSettingsResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\EdGraph\PlatformClient\Model\TenantApiTenantV1TenantAppSettings[]',
        'pageIndex' => 'int',
        'pageSize' => 'int',
        'count' => 'int'
    ];
