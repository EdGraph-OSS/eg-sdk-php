...
/**
 * TenantApiWebhookV1CreateWebhookRequest Class Doc Comment
 *
 * @category Class
 * @package  EdGraph\PlatformClient
 * @author   OpenAPI Generator team
 ...
 */
class TenantApiWebhookV1CreateWebhookRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TenantApi.Webhook.V1.CreateWebhookRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('secretHeader', $data ?? [], null);
     ...
     * @return string|null
     */
    public function getSecretHeader()
    {
        return $this->container['secretHeader'];
    }

    /**
     * Sets secretHeader
     *
     * @param string|null $secretHeader secretHeader
     *
     * @return self
     */
    public function setSecretHeader($secretHeader)
    {
        if (is_null($secretHeader)) {
            array_push($this->openAPINullablesSetToNull, 'secretHeader');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('secretHeader', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['secretHeader'] = $secretHeader;
     ...
     *
     * @return \EdGraph\PlatformClient\Model\TenantApiWebhookV1WebhookSubscriberResponse[]|null
     */
     ...
     *
     * @param \EdGraph\PlatformClient\Model\TenantApiWebhookV1WebhookSubscriberResponse[]|null $eventSubscriptions eventSubscriptions
     *
     * @return self
     */
    public function setEventSubscriptions($eventSubscriptions)
    {
        if (is_null($eventSubscriptions)) {
            array_push($this->openAPINullablesSetToNull, 'eventSubscriptions');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('eventSubscriptions', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
