...
/**
 * IdentityApiUserV1ComputedLicenseApplicationRole Class Doc Comment
 *
 * @category Class
 * @package  EdGraph\PlatformClient
 * @author   OpenAPI Generator team
 ...
 */
class IdentityApiUserV1ComputedLicenseApplicationRole implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'IdentityApi.User.V1.ComputedLicenseApplicationRole';
     ...
     * Sets isAssigned
     *
     * @param bool|null $isAssigned isAssigned
     *
     * @return self
     */
    public function setIsAssigned($isAssigned)
    {
        if (is_null($isAssigned)) {
            array_push($this->openAPINullablesSetToNull, 'isAssigned');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('isAssigned', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
