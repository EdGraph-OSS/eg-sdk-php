...
/**
 * IdentityApiClientSettingsTypeV1GetClientSettingsTypesResponse Class Doc Comment
 *
 * @category Class
 * @package  EdGraph\PlatformClient
 * @author   OpenAPI Generator team
 ...
 */
class IdentityApiClientSettingsTypeV1GetClientSettingsTypesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'IdentityApi.ClientSettingsType.V1.GetClientSettingsTypesResponse';
    ...
    protected static $openAPITypes = [
        ...
        'pageSize' => 'int',
        'count' => 'int',
        'data' => '\EdGraph\PlatformClient\Model\IdentityApiClientSettingsTypeV1ClientSettingsTypeResponse[]'
    ];
