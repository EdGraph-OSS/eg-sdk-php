...
/**
 * IMSAdminApiV1ConnectionsConnectionProfileResponse Class Doc Comment
 *
 * @category Class
 * @package  EdGraph\PlatformClient
 * @author   OpenAPI Generator team
 ...
 */
class IMSAdminApiV1ConnectionsConnectionProfileResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IMSAdminApi.V1.Connections.ConnectionProfileResponse';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'details' => '\EdGraph\PlatformClient\Model\IMSAdminApiV1ConnectionsConnectionDetails[]',
        'tiers' => '\EdGraph\PlatformClient\Model\IMSAdminApiV1TiersTier[]',
        'backupCodes' => '\EdGraph\PlatformClient\Model\IMSAdminApiV1DbBackupCodesDbBackupCode[]'
    ];
    ...
    protected static $setters = [
        ...
        'allowedTenants' => 'setAllowedTenants',
        'name' => 'setName',
        'details' => 'setDetails',
        'tiers' => 'setTiers',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('allowedTenants', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['allowedTenants'];
    }

    /**
     * Sets allowedTenants
     *
     * @param string[]|null $allowedTenants allowedTenants
     *
     * @return self
     */
    public function setAllowedTenants($allowedTenants)
    {
        if (is_null($allowedTenants)) {
            array_push($this->openAPINullablesSetToNull, 'allowedTenants');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('allowedTenants', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['allowedTenants'] = $allowedTenants;
     ...
     * Gets details
     *
     * @return \EdGraph\PlatformClient\Model\IMSAdminApiV1ConnectionsConnectionDetails[]|null
     */
     ...
     * Sets details
     *
     * @param \EdGraph\PlatformClient\Model\IMSAdminApiV1ConnectionsConnectionDetails[]|null $details details
     *
     * @return self
     */
     ...
     * Sets tiers
     *
     * @param \EdGraph\PlatformClient\Model\IMSAdminApiV1TiersTier[]|null $tiers tiers
     *
     * @return self
     */
     ...
     * Sets backupCodes
     *
     * @param \EdGraph\PlatformClient\Model\IMSAdminApiV1DbBackupCodesDbBackupCode[]|null $backupCodes backupCodes
     *
     * @return self
     */
    public function setBackupCodes($backupCodes)
    {
        if (is_null($backupCodes)) {
            array_push($this->openAPINullablesSetToNull, 'backupCodes');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('backupCodes', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
