...
/**
 * EdfiAdminApiEdfiAdminV1InstanceApplicationProfileResponse Class Doc Comment
 *
 * @category Class
 * @package  EdGraph\PlatformClient
 * @author   OpenAPI Generator team
 ...
 */
class EdfiAdminApiEdfiAdminV1InstanceApplicationProfileResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EdfiAdminApi.EdfiAdmin.V1.InstanceApplicationProfileResponse';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'apiClients' => '\EdGraph\PlatformClient\Model\EdfiAdminApiEdfiAdminV1InstanceApiClientProfileResponse[]',
        'createdBy' => 'string',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('apiClients', $data ?? [], null);
     ...
     * Gets apiClients
     *
     * @return \EdGraph\PlatformClient\Model\EdfiAdminApiEdfiAdminV1InstanceApiClientProfileResponse[]|null
     */
    public function getApiClients()
    {
        return $this->container['apiClients'];
    }

    /**
     * Sets apiClients
     *
     * @param \EdGraph\PlatformClient\Model\EdfiAdminApiEdfiAdminV1InstanceApiClientProfileResponse[]|null $apiClients apiClients
     *
     * @return self
     */
    public function setApiClients($apiClients)
    {
        if (is_null($apiClients)) {
            array_push($this->openAPINullablesSetToNull, 'apiClients');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('apiClients', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['apiClients'] = $apiClients;
