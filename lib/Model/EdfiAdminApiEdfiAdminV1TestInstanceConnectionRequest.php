...
/**
 * EdfiAdminApiEdfiAdminV1TestInstanceConnectionRequest Class Doc Comment
 *
 * @category Class
 * @package  EdGraph\PlatformClient
 * @author   OpenAPI Generator team
 ...
 */
class EdfiAdminApiEdfiAdminV1TestInstanceConnectionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EdfiAdminApi.EdfiAdmin.V1.TestInstanceConnectionRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('resourceUri', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets resourceUri
     *
     * @param string|null $resourceUri resourceUri
     *
     * @return self
     */
    public function setResourceUri($resourceUri)
    {
        if (is_null($resourceUri)) {
            array_push($this->openAPINullablesSetToNull, 'resourceUri');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('resourceUri', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
