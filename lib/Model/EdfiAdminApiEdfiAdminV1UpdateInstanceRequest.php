...
/**
 * EdfiAdminApiEdfiAdminV1UpdateInstanceRequest Class Doc Comment
 *
 * @category Class
 * @package  EdGraph\PlatformClient
 * @author   OpenAPI Generator team
 ...
 */
class EdfiAdminApiEdfiAdminV1UpdateInstanceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EdfiAdminApi.EdfiAdmin.V1.UpdateInstanceRequest';
     ...
     * Sets id
     *
     * @param string|null $id The Instance ID or Custom ID
     *
     * @return self
     */
