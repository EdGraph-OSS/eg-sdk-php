...
/**
 * FormApiFormsV1UpdateFullQuestionRequest Class Doc Comment
 *
 * @category Class
 * @package  EdGraph\PlatformClient
 * @author   OpenAPI Generator team
 ...
 */
class FormApiFormsV1UpdateFullQuestionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FormApi.Forms.V1.UpdateFullQuestionRequest';
    ...
    protected static $openAPITypes = [
        ...
        'required' => 'bool',
        'defaultValue' => 'string',
        'validation' => '\EdGraph\PlatformClient\Model\FormApiFormsV1UpdateFullQuestionValidationRequest',
        'options' => 'string[]',
        'order' => 'int',
        'component' => 'string',
        'customId' => 'string',
    ...
    */
     ...
     * Gets validation
     *
     * @return \EdGraph\PlatformClient\Model\FormApiFormsV1UpdateFullQuestionValidationRequest|null
     */
     ...
     * Sets validation
     *
     * @param \EdGraph\PlatformClient\Model\FormApiFormsV1UpdateFullQuestionValidationRequest|null $validation validation
     *
     * @return self
     */
