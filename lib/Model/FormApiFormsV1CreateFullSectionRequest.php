...
/**
 * FormApiFormsV1CreateFullSectionRequest Class Doc Comment
 *
 * @category Class
 * @package  EdGraph\PlatformClient
 * @author   OpenAPI Generator team
 ...
 */
class FormApiFormsV1CreateFullSectionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FormApi.Forms.V1.CreateFullSectionRequest';
    ...
    */
     ...
     * Gets questions
     *
     * @return \EdGraph\PlatformClient\Model\FormApiFormsV1CreateFullQuestionRequest[]|null
     */
     ...
     * Sets questions
     *
     * @param \EdGraph\PlatformClient\Model\FormApiFormsV1CreateFullQuestionRequest[]|null $questions questions
     *
     * @return self
     */
    public function setQuestions($questions)
    {
        if (is_null($questions)) {
            array_push($this->openAPINullablesSetToNull, 'questions');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('questions', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
