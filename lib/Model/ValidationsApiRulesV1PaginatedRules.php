...
/**
 * ValidationsApiRulesV1PaginatedRules Class Doc Comment
 *
 * @category Class
 * @package  EdGraph\PlatformClient
 * @author   OpenAPI Generator team
 ...
 */
class ValidationsApiRulesV1PaginatedRules implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ValidationsApi.Rules.V1.PaginatedRules';
    ...
    protected static $openAPITypes = [
        ...
        'pageSize' => 'int',
        'count' => 'int',
        'data' => '\EdGraph\PlatformClient\Model\ValidationsApiRulesV1RuleDto[]'
    ];
     ...
     * Sets data
     *
     * @param \EdGraph\PlatformClient\Model\ValidationsApiRulesV1RuleDto[]|null $data data
     *
     * @return self
     */
