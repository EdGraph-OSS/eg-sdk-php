...
/**
 * TenantApiPartnershipV1PartnershipByIdResponse Class Doc Comment
 *
 * @category Class
 * @package  EdGraph\PlatformClient
 * @author   OpenAPI Generator team
 ...
 */
class TenantApiPartnershipV1PartnershipByIdResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TenantApi.Partnership.V1.PartnershipByIdResponse';
    ...
    protected static $attributeMap = [
        ...
        'relatedTenantsIds' => 'relatedTenantsIds',
    ...
    protected static $setters = [
        'id' => 'setId',
        'partnerTenantId' => 'setPartnerTenantId',
        'partnershipType' => 'setPartnershipType',
        'relatedTenantsIds' => 'setRelatedTenantsIds',
    ...
    protected static $getters = [
        'id' => 'getId',
        'partnerTenantId' => 'getPartnerTenantId',
        'partnershipType' => 'getPartnershipType',
        'relatedTenantsIds' => 'getRelatedTenantsIds',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('partnerTenantId', $data ?? [], null);
        $this->setIfExists('partnershipType', $data ?? [], null);
        $this->setIfExists('relatedTenantsIds', $data ?? [], null);
    ...
    /**
     * Gets partnerTenantId
     *
     * @return string|null
     */
    public function getPartnerTenantId()
    {
        return $this->container['partnerTenantId'];
    }

    /**
     * Sets partnerTenantId
     *
     * @param string|null $partnerTenantId partnerTenantId
     *
     * @return self
     */
    public function setPartnerTenantId($partnerTenantId)
    {
        if (is_null($partnerTenantId)) {
            array_push($this->openAPINullablesSetToNull, 'partnerTenantId');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('partnerTenantId', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['partnerTenantId'] = $partnerTenantId;
    ...
    /**
     * Gets relatedTenantsIds
     *
     * @return string[]|null
     */
    public function getRelatedTenantsIds()
    {
        return $this->container['relatedTenantsIds'];
    }

    /**
     * Sets relatedTenantsIds
     *
     * @param string[]|null $relatedTenantsIds relatedTenantsIds
     *
     * @return self
     */
    public function setRelatedTenantsIds($relatedTenantsIds)
    {
        if (is_null($relatedTenantsIds)) {
            array_push($this->openAPINullablesSetToNull, 'relatedTenantsIds');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('relatedTenantsIds', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['relatedTenantsIds'] = $relatedTenantsIds;
