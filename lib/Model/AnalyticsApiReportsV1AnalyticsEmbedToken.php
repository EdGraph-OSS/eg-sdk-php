...
/**
 * AnalyticsApiReportsV1AnalyticsEmbedToken Class Doc Comment
 *
 * @category Class
 * @package  EdGraph\PlatformClient
 * @author   OpenAPI Generator team
 ...
 */
class AnalyticsApiReportsV1AnalyticsEmbedToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AnalyticsApi.Reports.V1.AnalyticsEmbedToken';
    ...
    {
        if (is_null($tokenId)) {
            array_push($this->openAPINullablesSetToNull, 'tokenId');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tokenId', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
