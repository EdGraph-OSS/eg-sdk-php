...
/**
 * EdfiAdminApiEdfiAdminV1DescriptorType Class Doc Comment
 *
 * @category Class
 * @package  EdGraph\PlatformClient
 * @author   OpenAPI Generator team
 ...
 */
class EdfiAdminApiEdfiAdminV1DescriptorType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EdfiAdminApi.EdfiAdmin.V1.DescriptorType';
    ...
    {
        $this->setIfExists('descriptorId', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['descriptorId'];
    }

    /**
     * Sets descriptorId
     *
     * @param int|null $descriptorId descriptorId
     *
     * @return self
     */
    public function setDescriptorId($descriptorId)
    {
        if (is_null($descriptorId)) {
            throw new \InvalidArgumentException('non-nullable descriptorId cannot be null');
        }
        $this->container['descriptorId'] = $descriptorId;
