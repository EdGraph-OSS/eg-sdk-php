...
/**
 * EdGraphHttpAggregatorsTenantApiControllersV1ViewModelsResponsesDomainListResponseDto Class Doc Comment
 *
 * @category Class
 * @package  EdGraph\PlatformClient
 * @author   OpenAPI Generator team
 ...
 */
class EdGraphHttpAggregatorsTenantApiControllersV1ViewModelsResponsesDomainListResponseDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EdGraph.HttpAggregators.Tenant.Api.Controllers.v1.ViewModels.Responses.DomainListResponseDto';
    ...
    public function setManuallyVerified($manuallyVerified)
    {
        if (is_null($manuallyVerified)) {
            throw new \InvalidArgumentException('non-nullable manuallyVerified cannot be null');
        }
