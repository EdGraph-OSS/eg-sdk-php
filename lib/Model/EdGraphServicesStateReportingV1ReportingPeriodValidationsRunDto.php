...
/**
 * EdGraphServicesStateReportingV1ReportingPeriodValidationsRunDto Class Doc Comment
 *
 * @category Class
 * @package  EdGraph\PlatformClient
 * @author   OpenAPI Generator team
 ...
 */
class EdGraphServicesStateReportingV1ReportingPeriodValidationsRunDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EdGraph.Services.StateReporting.V1.ReportingPeriodValidationsRunDto';
    ...
    protected static $setters = [
        'requestedDateTime' => 'setRequestedDateTime',
    ...
    protected static $getters = [
        'requestedDateTime' => 'getRequestedDateTime',
    ...
    {
        $this->setIfExists('requestedDateTime', $data ?? [], null);
    ...
    /**
     * Gets requestedDateTime
     *
     * @return string|null
     */
    public function getRequestedDateTime()
    {
        return $this->container['requestedDateTime'];
    }

    /**
     * Sets requestedDateTime
     *
     * @param string|null $requestedDateTime requestedDateTime
     *
     * @return self
     */
    public function setRequestedDateTime($requestedDateTime)
    {
        if (is_null($requestedDateTime)) {
            array_push($this->openAPINullablesSetToNull, 'requestedDateTime');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('requestedDateTime', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['requestedDateTime'] = $requestedDateTime;
