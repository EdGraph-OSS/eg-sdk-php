...
/**
 * ValidationsApiJobsV1Metric Class Doc Comment
 *
 * @category Class
 * @package  EdGraph\PlatformClient
 * @author   OpenAPI Generator team
 ...
 */
class ValidationsApiJobsV1Metric implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ValidationsApi.Jobs.V1.Metric';
