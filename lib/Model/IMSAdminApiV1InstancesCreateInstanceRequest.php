...
/**
 * IMSAdminApiV1InstancesCreateInstanceRequest Class Doc Comment
 *
 * @category Class
 * @package  EdGraph\PlatformClient
 * @author   OpenAPI Generator team
 ...
 */
class IMSAdminApiV1InstancesCreateInstanceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'IMSAdminApi.V1.Instances.CreateInstanceRequest';
     ...
     * Sets backupCode
     *
     * @param string|null $backupCode backupCode
     *
     * @return self
     */
    public function setBackupCode($backupCode)
    {
        if (is_null($backupCode)) {
            array_push($this->openAPINullablesSetToNull, 'backupCode');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('backupCode', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
