...
class MyPreferencesApi
{
    ...
    public function getUserPreferencesWithHttpInfo($pageIndex = 0, $pageSize = 10, $orderBy = null, $filter = null, string $contentType = self::contentTypes['getUserPreferences'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\EdGraph\PlatformClient\Model\IdentityApiUserV1GetUserPreferencesResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\EdGraph\PlatformClient\Model\IdentityApiUserV1GetUserPreferencesResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EdGraph\PlatformClient\Model\IdentityApiUserV1GetUserPreferencesResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
     ...
     *
     * @param  \EdGraph\PlatformClient\Model\EdGraphHttpAggregatorsTenantApiControllersV1ViewModelsRequestsUpdateUserPreferenceRequest $edGraphHttpAggregatorsTenantApiControllersV1ViewModelsRequestsUpdateUserPreferenceRequest  (optional)
    ...
    public function updateUserPreferenceAsyncWithHttpInfo($edGraphHttpAggregatorsTenantApiControllersV1ViewModelsRequestsUpdateUserPreferenceRequest = null, string $contentType = self::contentTypes['updateUserPreferenceAsync'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\EdGraph\PlatformClient\Model\IdentityApiUserV1UserPreferenceUpdatedResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\EdGraph\PlatformClient\Model\IdentityApiUserV1UserPreferenceUpdatedResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EdGraph\PlatformClient\Model\IdentityApiUserV1UserPreferenceUpdatedResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
