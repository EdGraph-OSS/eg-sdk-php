...
class MyExtensionsApi
{
    ...
    public function removeUserExtensionWithHttpInfo($code, string $contentType = self::contentTypes['removeUserExtension'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\EdGraph\PlatformClient\Model\IdentityApiUserV1UserExtensionRemovedResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\EdGraph\PlatformClient\Model\IdentityApiUserV1UserExtensionRemovedResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EdGraph\PlatformClient\Model\IdentityApiUserV1UserExtensionRemovedResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     *
     * @param  \EdGraph\PlatformClient\Model\IdentityApiUserV1SetUserExtensionRequest $identityApiUserV1SetUserExtensionRequest  (optional)
    ...
    public function setUserExtensionWithHttpInfo($identityApiUserV1SetUserExtensionRequest = null, string $contentType = self::contentTypes['setUserExtension'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\EdGraph\PlatformClient\Model\IdentityApiUserV1UserExtensionSetResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\EdGraph\PlatformClient\Model\IdentityApiUserV1UserExtensionSetResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EdGraph\PlatformClient\Model\IdentityApiUserV1UserExtensionSetResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
