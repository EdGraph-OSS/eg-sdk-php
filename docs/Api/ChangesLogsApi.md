# EdGraph\PlatformClient\ChangesLogsApi

All URIs are relative to https://api.dev.edgraph.com/tenant, except if the operation defines another base path.

| Method | HTTP request | Description |
| ------------- | ------------- | ------------- |
| [**getAllChangesAsync()**](ChangesLogsApi.md#getAllChangesAsync) | **GET** /changes/{tenantId}/changes |  |
...
$apiInstance = new EdGraph\PlatformClient\Api\ChangesLogsApi(
...
try {
    ...
    echo 'Exception when calling ChangesLogsApi->getAllChangesAsync: ', $e->getMessage(), PHP_EOL;
}
```
